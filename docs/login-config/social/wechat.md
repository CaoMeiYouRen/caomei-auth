...
微信是中国最大的社交平台和支付工具，拥有超过 10 亿活跃用户，是中国应用必备的登录方式。

> [!CAUTION]
>
> 由于 better-auth 的 OAuth 插件存在问题，目前无法正常通过微信进行第三方登录，参考 [#7](https://github.com/CaoMeiYouRen/caomei-auth/issues/7) 。
