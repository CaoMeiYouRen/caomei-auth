...
| tests/unit/utils/navigation.spec.ts       | 4        | 2025-11-17 | QA     | 2025-11-17 重试仍失败：Nuxt auto-import mocks 与 `navigateTo` stub 未接入；2025-11-18 引入 `setNavigationDependencies` 注入 hook 并恢复执行（已恢复） |
